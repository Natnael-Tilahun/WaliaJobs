...
export const SubscribeSection = () => {
  return (
    <div className="w-full text-center md:py-20 py-16 px-10 lg:justify-evenly md:items-center md:px-10 bg-[#F5F5F5] items-center md:justify-between lg:px-20 flex flex-col lg:flex-row gap-5 md:gap-8">
