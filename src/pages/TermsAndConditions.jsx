...
const TermsAndConditions = () => {
  return (
    <div className="w-full h-full text-left md:py-10 bg-thm_secondary_background dark:bg-thm_dark_secondary_background py-5  flex-col my-0 flex md:my-0 px-2 md:px-3 lg:px-10 xl:px-20 ">
      <h1 className="text-xl font-medium pt-10 pb-3">Terms and Conditions</h1>
      <p>Last Updated: Oct 16, 2023</p>
      <p>
        Please read these Terms and Conditions ("Terms") carefully before using
        the Walia Jobs website and services (referred to as "us," "we," or
        "our"). Your access to and use of the service is conditioned on your
        acceptance and compliance with these Terms. By accessing or using the
      ...
      <ol className="text-left space-y-3 py-3 list-decimal">
        <li>
          <strong>2. Eligibility</strong> Provide accurate and truthful
