  ...
  return (
    ...
    >
      ...
      <div className="flex  justify-between gap-3 md:gap-5 lg:gap-10 flex-wrap w-full lg:p-5">
        ...
        <NavLink
          to={-1}
          className="z-50 text-center mr-auto self-center border-2 uppercase border-thm_primary_color font-bold w-auto px-10  md:px-20 py-1 my-5 md:my-0 md:mt-5  rounded-md basis-[40%] md:basis-[100%] lg:basis-[40%] xl:basis-[25%]"
        >
          Back
        </NavLink>
        <button
          ...
          className="border-2 z-50 self-center text-center uppercase bg-thm_root1_color text-white font-bold px-5  md:px-20 py-2 lg:my-5 rounded-md basis-[40%] md:basis-[100%] lg:basis-[40%] xl:basis-[25%]"
        >
          Continue
        </button>
      </div>
