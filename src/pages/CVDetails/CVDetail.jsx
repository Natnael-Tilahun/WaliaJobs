          ...
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <h2 className="md:text-sm text-xs font-medium text-white">
                {data.personalInformation.position}
              </h2>
            </div>
          </div>
        </div>
          ...
          <div className="bg-slate-300 basis-[25%] text-xxxs md:text-xxs p-2 md:p-3 flex flex-col gap-1">
            ...
            <div className="flex items-center gap-1">
              ...
              <p className="">
                ...
                {data.contactInformation.postcode}
              </p>
            </div>
            <div className="flex items-center gap-1">
              <svg
              ...
              <p className="">{data.contactInformation.phone}</p>
            </div>
            <div className="flex gap-1 items-center">
              ...
              <p className="">{data.contactInformation.email}</p>
            </div>
            <hr className="my-1" />
