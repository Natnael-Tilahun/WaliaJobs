...
export const SavedJobs = () => {
  const FavoriteJobs = JobsData.filter((job) => job.isFavorite);
  return (
    <div className="w-full h-full  bg-thm_secondary_background  flex-col  my-0 flex md:my-0  gap-2 lg:gap-10">
      ...
      <div className="flex flex-wrap flex-col lg:flex-row lg:justify-between gap-10 md:py-10  py-5  md:px-5 lg:px-10 xl:px-20 px-5">
