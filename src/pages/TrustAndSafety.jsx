  ...
  return (
    <div className="w-full h-full text-left md:py-10 bg-thm_secondary_background dark:bg-thm_dark_secondary_background py-5  flex-col my-0 flex md:my-0 px-2 md:px-3 lg:px-10 xl:px-20 ">
      ...
      <p>
        ...
        commitment to maintaining a trustworthy and respectful environment for
        all users. By using our services, you agree to abide by this Trust and
        Safety Policy. Please read it carefully.
      </p>
      <h1 className="text-lg font-medium pt-10 pb-3">User Responsibilities</h1>
      <p>
        As a user of Walia Jobs, you agree to the following responsibilities:
      </p>
      ...
      <h1 className="text-lg font-medium pt-10 pb-3">Prohibited Conduct</h1>
      ...
      <h1 className="text-lg font-medium pt-10 pb-3">Reporting Violations</h1>
      <p>
        If you believe a user has violated our Trust and Safety Policy, please
        report the incident to us immediately. We take such reports seriously
        and will take appropriate action.If you believe a user has violated our
        Trust and Safety Policy, please report the incident to us immediately.
        We take such reports seriously and will take appropriate action.
      </p>

      <h1 className="text-lg font-medium pt-10 pb-3">User Safety</h1>
      <p>
        While we strive to maintain a safe environment, it's essential for users
        to exercise caution and common sense when interacting with others on our
        platform. We recommend the following safety measures:
      </p>
      <ol className="text-left space-y-3 py-3 list-decimal">
        <li>
