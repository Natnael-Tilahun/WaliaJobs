  ...
  return (
    <div>
      <div className=" gap-x-10 gap-y-10 md:gap-y-20 grid grid-cols-2 px-5 md:grid-cols-3 md:flex-row py-5 flex-wrap md:py-10  md:px-3 lg:px-20">
        <NavLink to="/cv_details/1" className="lg:w-1/2">
          <CvTemplate
            img="/cvTemplate1.png"
        ...
        <NavLink to="/cv_details/4" className="lg:w-1/2">
          <CvTemplate
            img="/cvTemplate4.png"
            className="rounded-md basis-1/3 w-full  shadow-md"
          />
        </NavLink>
        <NavLink to="/cv_details/5" className="lg:w-1/2">
          <CvTemplate
            img="/cvTemplate5.png"
            className="rounded-md basis-1/3 w-full shadow-md"
          />
        </NavLink>
        <NavLink to="/cv_details/6" className="lg:w-1/2">
          <CvTemplate
            img="/cvTemplate2.png"
            className="rounded-md basis-1/3 w-full shadow-md"
          />
